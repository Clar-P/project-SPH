    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <!-- 如果服务器数据没返回来，skuInfo这个对象是空对象，会报假错误 -->
...
import ImageList from './ImageList/ImageList'
  ...
  export default {
    ...
    methods:{
      // 产品的售卖属性值切换高亮
      changeActive(saleAttr,AttrList){
        // 遍历全部售卖属性值isChecked都为0就够没有高亮了,先全部不亮，再让点那个亮
      ...
      // 表单元素修改产品个数
      changeSkuNum(e){
        // 用户输入的内容 * 1，如果不是数字会返回 NaN
        let value = e.target.value * 1
        // 如果用户输入的数非法，value就会出现 NaN(不是数字)或者小于1
